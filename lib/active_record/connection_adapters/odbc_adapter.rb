...
module ActiveRecord
  ...
  module ConnectionAdapters
    class ODBCAdapter < AbstractAdapter
      ...
      def new_column(name, default, sql_type_metadata, null, _table_name, default_function = nil, collation = nil, _native_type = nil)
        ::ODBCAdapter::Column.new(name, default, sql_type_metadata, null, default_function, collation: collation)
      end
